/*Ex.1
Să se modifice declansatorul inregistrare_noua, în așa fel, încât în cazul actualizării auditoriului să apară mesajul de informare, care, 
în afară de disciplina și ora, va afișa codul grupei afectate, ziua, blocul, auditoriul vechi și auditoriul nou.
*/
...
/*Ex.2
Să se creeze declansatorul, care ar asigura popularea corectă (consecutivă) a tabelelor studenti și studenti_reusita,
 și ar permite evitarea erorilor la nivelul cheilor exteme.
*/
...
/*Ex.3
Să se creeze un declanșator, care ar interzice micșorarea notelor în tabelul studenti_reusita și modificarea valorilor 
câmpului Data_Evaluare, unde valorile acestui câmp sunt nenule. 
Declanșatorul trebuie să se lanseze, numai dacă sunt afectate datele studenților din grupa "CIB 171".
Se va afișa un mesaj de avertizare în cazul tentativei de a încălca constrângerea.
*/
...
/*Ex.4
Să se creeze un declanșator DDL care ar interzice modificarea 
coloanei ld_Disciplina în tabelele bazei de date universitatea cu afișarea mesajului respectiv.
*/
...
/*Ex.5
Să se creeze un declanșator DDL care ar interzice modificarea schemei bazei de date în afara orelor de lucru.
*/
...
/*Ex.6
Să se creeze un declanșator DDL care, la modificarea proprietăților coloanei ld_Profesor dintr-un tabel, 
ar face schimbări asemănătoare în mod automat în restul tabelelor.
*/
